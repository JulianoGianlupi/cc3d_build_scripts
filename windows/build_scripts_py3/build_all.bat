...
C:\Users\jferrari\AppData\Local\Continuum\anaconda3\envs\conda_2020\python .\win_cc3d_builder.py  -p C:/install_projects/%version%-64bit -s C:/CC3D_PY3_GIT  -i C:/CC3D_FILES_SVN/binaries/%version%/windows -v %version%.0 --config=config_64bit.json 
